...
const contractAddr = '5C9gEAeCHEZuXMWovND6aQXGuYrVVA6GsuLGURT8GJ6qAnvT';
const userName = 'user';
...
const plansCharacteristic = [['plan0'], ['plan1_0', 'plan1_1'], ['plan2_0', 'plan2_1', 'plan3_2']];
