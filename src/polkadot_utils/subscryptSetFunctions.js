...
/**
 * @function - A Send function, And ItSets The Subscrypt Password
 * @param {string} address - Address Of Sender
 * @param {string} injector - Object That Signs Tx
 * @param args - Arguments Of The Function
 * @param {string} args[0] - new Password
 ...
 * @param {number} args[4] - max_refund_permille_poi
